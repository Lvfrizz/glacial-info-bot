...
RULES = {
    ...
    "tribe": {
        ...
        "description": (
            ...
            "*(Allies cannot participate in raids on small tribes)*\n\n"
    ...
    "pvp": {
        ...
        "description": (
            ...
            "*(Alliance attacking during a raid on small tribes is not allowed)*\n\n"
    ...
    "extra": {
        ...
        "description": (
            ...
            "• Limited amount of dinos outside of cryos for defending (max ~10-20). Excessive amounts may be red-gunned by staff.\n"
